...
public class PracticeDropDownSelectByValue {
	
	public static WebDriver driver;
	
	public void testDropDownSelectByValue() throws InterruptedException
	{
		...
		select.selectByValue(toBeSelected);
	...
	public static void main(String[] args) throws InterruptedException {
		...
		PracticeDropDownSelectByValue dd = new PracticeDropDownSelectByValue();
		dd.testDropDownSelectByValue();
	}
}
