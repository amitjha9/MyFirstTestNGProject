...
public class PracticeCheckBox1 {
	...
	public void testCheckBox() throws InterruptedException
	{
		...
		String successText ="Success - Check box is checked";
		if(flag==true)
		{
			...
			Assert.assertEquals(getText, successText);
		}
	...
	public static void main(String[] args) throws InterruptedException {
		...
		PracticeCheckBox1 pc = new PracticeCheckBox1();
        pc.testCheckBox();
	}
